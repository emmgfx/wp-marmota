        ...
        <nav class="navbar navbar-expand-<?php echo esc_attr(get_theme_mod("navbar-expand", "md")); ?> sticky-top">
            <div class="container">
                ...
                <div id="navigation" class="collapse navbar-collapse">
                    ...
                    <form class="search form-inline my-3 my-<?php echo esc_attr(get_theme_mod("navbar-expand", "md")); ?>-0 d-<?php echo esc_attr(get_theme_mod("navbar-expand", "md")); ?>-none" role="search" method="get" action="<?php echo home_url( '/' ); ?>">
