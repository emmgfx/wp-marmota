        ...
        <nav class="navbar navbar-expand-md sticky-top">
            <div class="container">
                ...
                <div id="navigation" class="collapse navbar-collapse">
                    ...
                    ?>
                    <button class="search-toggler d-none d-md-block">
                        <svg viewBox="0 0 24 24">
                    ...
                    <form class="search form-inline my-3 my-md-0 d-md-none" role="search" method="get" action="<?php echo home_url( '/' ); ?>">
                        <div class="pseudo-container d-flex">
                            ...
                            <button class="close-search btn btn-sm d-none d-md-inline">
