...
function marmota_enqueue_style() {
  ...
  wp_enqueue_style( 'Rubik', 'https://fonts.googleapis.com/css?family=Rubik:300,300i,400,500,500i&display=swap' );
}
add_action( 'wp_enqueue_scripts', 'marmota_enqueue_style' );

function marmota_enqueue_script() {
  wp_enqueue_script( 'jquery' );
  wp_enqueue_script( 'bootstrap', esc_url(get_template_directory_uri()) . '/js/bootstrap-4.4.1-dist/js/bootstrap.min.js', array('jquery'), '4.4.1', true );
